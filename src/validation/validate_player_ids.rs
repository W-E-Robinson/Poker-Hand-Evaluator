...
mod tests {
    ...
    #[test]
    fn test_duplicate_ids_given_texas_holdem() {
        let hand = Hand {
            id: String::from("hand-id"),
    ...
    #[test]
    fn test_valid_player_ids_texas_holdem() {
        let hand = Hand {
            id: String::from("hand-id"),
            variant: Variant::TexasHoldem,
            players: vec![
    ...
    #[test]
    fn test_duplicate_ids_given_four_card_omaha_hi() {
        let hand = Hand {
            id: String::from("hand-id"),
    ...
    #[test]
    fn test_valid_player_ids_four_card_omaha_hi() {
        let hand = Hand {
            id: String::from("hand-id"),
            variant: Variant::FourCardOmahaHi,
            players: vec![
